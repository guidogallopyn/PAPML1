...
* PAPML1.Rmd: R markdown file for the written submission of the assessment
* PAPML1.md : generated markdown file
* PAPML1.html: compiled HTML with written report
* scripts: directory with R scripts
  + PAPML1.Explore.R: script for data set exploration
  + PAPML1.PP.R: script to load and pre-process data
  + PAPML1.Report.R: script to generate resources (graphics, tables) for report
  + PAPML1.Mod.R: script for model building
  + PAPML1.Score.R: script for producing predictions on the testing data and prepare files or submission
...
* score: directory with prediction files for the 20 point testing 
